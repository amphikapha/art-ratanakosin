...
const contactInfo = [
  ...
  },
  {
    icon: Clock,
    title: "เวลาเปิด-ปิด",
    details: ["เปิดทุกวัน", "07.30 - 19.00 น."],
  },
  {
    icon: Phone,
    title: "ติดต่อ",
    details: ["โทร: 02-621-0576", "โทร: 02-223-4561"],
  },
];
...
const transportOptions = [
  {
    icon: Bus,
    title: "รถประจำทาง",
    description: "สาย 8, 15, 37, 47, 49 ปอ. 37, 49",
  },
  {
    icon: Ship,
    title: "เรือโดยสาร",
    description: "ท่าเรือผ่านฟ้าลีลาศ แล้วเดินต่อ ใช้เวลาประมาณ 10 นาที",
  },
  {
    icon: Train,
    title: "รถไฟฟ้า MRT (สายสีน้ำเงิน)",
    description:
      "ลงสถานีสามยอด ใช้ทางออกประตู 1 เดินเท้าใช้เวลาประมาณ 10 - 15 นาที",
  },
  {
    icon: CarFront,
    title: "รถส่วนตัว",
    description: "จอดภายในบริเวณวัดได้",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
                ...
                >
                  <CardContent className="px-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-serif text-lg font-semibold text-deep-red">
                          {info.title}
                        </h4>
              ...
              <div className="space-y-3">
                {transportOptions.map((option, index) => (
                  ...
                  >
                    ...
                    <div>
                      <h5 className="font-medium text-brown-dark">
                        {option.title}
                      </h5>
          ...
          <div className="h-full min-h-[400px]">
            <a
              href="https://maps.google.com/?cid=10094722561517961364&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQ"
              target="_blank"
